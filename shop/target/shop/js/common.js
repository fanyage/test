$(document).ready(function(){
	var htmlCode = '<table width="60%" border="1px" cellspacing="0" cellpadding="10"><tr><td><a onclick="goFirst()">首页</a></td><td><a onclick="goPri()">上一页</a></td>'+
				   '<td>第<span id="cpage">1</span>页&nbsp;共<span id="totalPage">0</span>页</td>'+
				   '<td><a onclick="goNext()">下一页</a></td><td><a onclick="goLast()">尾页</a></td><td>展示<select id="pageSize" onchange="changePageSize()"><option value="2" selected>2</option><option value="4">4</option><option value="6">6</option></select>条</td><td><input type="text" id="targetPage" style="width: 60px">'+
